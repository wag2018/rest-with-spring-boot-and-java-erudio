...
public class PersonRepositoryTest extends AbstractIntegrationTest {
	...
	public void testFindByName() throws JsonMappingException, JsonProcessingException {
		...
		person = repository.findPersonsByName("wag", pageable).getContent().get(0);
		...
		assertEquals("Wagner", person.getFirstName());
		assertEquals("Machado", person.getLastName());
		assertEquals("Rio", person.getAddress());
